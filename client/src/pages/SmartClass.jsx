...
import smartClassroomImg from '../assets/gen-smart-campus.png';
import smartMeetingImg from '../assets/gen-smart-access.png';
import auditoriumImg from '../assets/smart-sensor.png';
import avAutomationImg from '../assets/smart-energy.png';
        ...
        {subservices.map((service, index) => (
          ...
          >
            ...
            <div className="sc-visual-content">
              <img src={service.image} alt={service.title} className="sc-visual-image" />
