...
const AdminLogin = () => {
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch('https://company-d78j.onrender.com/api/admin/login', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="page-container" style={{ minHeight: '100vh', marginTop: '5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2rem' }}>
            <motion.div 
                className="glass" 
